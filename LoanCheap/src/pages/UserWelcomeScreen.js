      ...
      <View style={{ flex: 1, padding: 16 }}>
        ...
        <View>
          ...
          >
            ...
            <Text style={{ fontSize: 16 }}>
              View pending and accepted loans you submitted
            </Text>
          </View>
        </View>
        <View
        ...
        <View>
          ...
          >
            <Text style={{ fontSize: 16, marginRight: 8 }}>2.</Text>
            <Text style={{ fontSize: 16 }}>
              See submitted requests for loans from users
            </Text>
          </View>
          <View
            style={{
          ...
          >
            <Text style={{ fontSize: 16, marginRight: 8 }}>3.</Text>
            <Text style={{ fontSize: 16 }}>
              Accept and reject requests for loans you created
            </Text>
          </View>
          <View
            style={{
          ...
          >
            ...
            <Text style={{ fontSize: 16 }}>
              Contact users who submitted for your loans via phone or email
            </Text>
          </View>
          <View
            style={{
